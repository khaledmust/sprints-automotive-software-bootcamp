...
//fptr_TIMER0_CallBackFunction = NULL;
 ...
 * @return TIMER_STATUS_SUCCESS
 */
static st_TIMERAPIStatus TIMER_OCPinOps(en_TIMER_OperationMode_t en_TIMER_OperationMode, en_TIMER_OutputCompareModeOp_t en_TIMER_OutputCompareModeOp) {
    switch (en_TIMER_OperationMode) {
        case TIMER_CTC_MODE:
...
void TIMER_Init(st_TIMER_config_t *ptr_st_TIMER_config) {
    ...
    TIMER_SetOpMode(ptr_st_TIMER_config->en_TIMER_OperationMode);
    
    TIMER_OCPinOps(ptr_st_TIMER_config->en_TIMER_OperationMode, ptr_st_TIMER_config->en_TIMER_OutputCompareModeOp);
    ...
    TIMER_SetClkPresclr(ptr_st_TIMER_config->en_TIMER_ClockSelect);
}
